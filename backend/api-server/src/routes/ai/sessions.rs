...
pub(super) async fn create_session(
    ...
    let session = ChatStore::create_session(db, user_uuid, req.title.as_deref())
        .await
        .map_err(|e| {
...
pub(super) async fn list_sessions(
    ...
    let sessions = ChatStore::list_sessions(db, user_uuid, 50)
        .await
        .map_err(|e| {
...
pub(super) async fn get_session_messages(
    ...
    let messages = ChatStore::load_messages_for_user(db, session_uuid, user_uuid, 100)
        .await
        .map_err(|e| {
...
pub(super) async fn delete_session(
    ...
    let deleted = ChatStore::delete_session(db, session_uuid, user_uuid)
        .await
        .map_err(|e| {
