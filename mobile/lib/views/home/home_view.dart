            ...
            children: [
              Expanded(
                child: _showcaseCard(
                  ...
                  title: S.scAiReads,
                  desc: S.scAiReadsSub,
                  onTap: () => AppShell.goToChatAndSend(context, S.featureAiIntent),
                ),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: _showcaseCard(
                  ...
                  onTap: () => AppShell.goToChatAndSend(context, S.featureProxyPay),
                ),
              ),
            ],
          ),
            ...
            children: [
              Expanded(
                child: _showcaseCard(
                  ...
                  title: S.scFamily,
                  desc: S.scFamilySub,
                  onTap: () => AppShell.goToChatAndSend(context, S.featureFamily),
                ),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: _showcaseCard(
                  ...
                  title: S.scSkills,
                  desc: S.scSkillsSub,
                  onTap: () => AppShell.goToChatAndSend(context, S.featureSkills),
                ),
              ),
            ],
          ),
